...
st.write("This app uses 6 inputs to predict the species of penguin using a model built on the Palmer's Penguin's dataset. \
...
### Displaying the prediction information:
st.subheader("Predicting Your Penguin's Species:")
st.write('We predict your penguin is of the {} species'.format(prediction_species))
st.write('We used a machine learning (Random Forest) model to predict the species, the features used in this\
             prediction are ranked by relative importance below.')
st.image('feature_importance.png')

### Histogram of the Features along with the given point of prediction:
